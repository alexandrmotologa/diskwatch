...
Marvell Kirkwood NAS boxes (e.g. Iomega ix2-dl) running Debian. Windows x86_64 binaries
are also available; extract the archive and run `diskwatch-windows-x86_64.exe`.
